...
glm::mat4 createLookAtMatrix(glm::vec3 eye, glm::vec3 target) {
    ...
    return glm::mat4(
        side.x, up.x, -fwd.x, 0.0f,
        side.y, up.y, -fwd.y, 0.0f,
        side.z, up.z, -fwd.z, 0.0f,
        -glm::dot(side, eye), -glm::dot(eye, up), -glm::dot(eye, -fwd), 1.0f
    );
}
...
void display(GLFWwindow* window, double currentTime) {
    ...
    vMat = glm::lookAt(glm::vec3(cameraX, cameraY, cameraZ), glm::vec3(
        sin((float)currentTime) * 8.0f, 0.0f, cos((float)currentTime) * 8.0f
    ), glm::vec3(0.0f, 1.0f, 0.0f));
    //vMat = glm::transpose(createLookAtMatrix(glm::vec3(cameraX, cameraY, cameraZ), glm::vec3(0.0f, 0.0f, 0.0f)));
    mvStack.push(vMat);
    ...
    mvStack.push(mvStack.top());
    mvStack.top() *= glm::translate(glm::mat4(1.0f), glm::vec3(
        0.0f, sin((float)currentTime * 8.0f) * 3.0f, cos((float)currentTime * 8.0f) * 3.0f
    ));
    mvStack.push(mvStack.top());
    mvStack.top() *= glm::rotate(glm::mat4(1.0f), (float)currentTime, glm::vec3(0.0f, 1.0f, 0.0f));
